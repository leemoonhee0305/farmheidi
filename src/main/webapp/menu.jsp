	...
	<nav id="stNav" class="navbar navbar-expand-sm">
		...
		<ul class="navbar-nav nav-topCenter">
			<li class="nav-item nav-firstItem">
				<a class="nav-link tmenu" href="/introduce.jsp" id="navbardrop" style="font-family:'SUITE-Regular';">소개글</a>
			</li>
			<li class="nav-item">
				<a class="nav-link tmenu" href="/playMain.do" id="navbardrop" style="font-family:'SUITE-Regular';">체험소개</a>
			</li>
			<li class="nav-item">
				<a class="nav-link tmenu" href="/resvMain.do" style="font-family:'SUITE-Regular';">체험예약</a>
			</li>
			<li class="nav-item">
				<a class="nav-link tmenu" href="/productList.do" style="font-family:'SUITE-Regular';">상품</a>
			</li>
			<li class="nav-item">
				<a class="nav-link tmenu" href="/getNoticeList.do" id="navbardrop" style="font-family:'SUITE-Regular';"> 커뮤니티 </a>
			</li>
		</ul>
