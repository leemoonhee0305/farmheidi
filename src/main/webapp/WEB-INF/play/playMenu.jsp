	...
	<nav id="stNav" class="navbar navbar-expand-sm">
		...
		<ul class="navbar-nav nav-topCenter">
			<li class="nav-item nav-firstItem">
				<a class="nav-link" href="/introduce.jsp" style="font-family:'SUITE-Regular';" id="navbardrop">소개글</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/playMain.do" style="font-family:'SUITE-Regular';" id="navbardrop">체험소개</a>
			</li>
			<li class="nav-item">
...
<div id="box">
<div class="row">
		<div id="content1" class="col"><a id="content1" class="nav-link item-bottom" style="font-family:'SUITE-Regular';" href="playMain.do">체험소개</a></div>
		<div id="content2" class="col"><a id="content2" class="nav-link item-bottom" style="font-family:'SUITE-Regular';" href="/playSchedule.do?clickCount=0">체험일정</a></div>
		<div id="content3" class="col"><a id="content3" class="nav-link item-bottom" style="font-family:'SUITE-Regular';" href="playQNA.do">FAQ</a></div>
	</div>
</div>
