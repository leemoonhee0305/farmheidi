...
<div id="active-box">
  ...
  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
	...
	<div id="logo-box">
		<a class="navbar-brand" href="/main.jsp"> 
		<img id="logo" src="${pageContext.request.contextPath }/resources/img/mainlogo.png">
		</a>
	</div>
		<ul class="navbar-nav nav-topCenter">
			<li class="nav-item nav-firstItem">
				<a class="nav-link" href="/introduce.jsp" id="navbardrop" style="font-family:'SUITE-Regular';">소개글</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/playMain.do" id="navbardrop" style="font-family:'SUITE-Regular';">체험소개</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/resvMain.do" style="font-family:'SUITE-Regular';">체험예약</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/productList.do" style="font-family:'SUITE-Regular';">상품</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/getNoticeList.do" id="navbardrop" style="font-family:'SUITE-Regular';"> 커뮤니티 </a>
			</li>
		</ul>
...
<div id="box">
<div class="row">
		<div id="content1" class="col"><a id="content1" class="nav-link item-bottom " style="font-family:'SUITE-Regular';" href="myinfoUser.do">내 정보</a></div>
		<div id="content2" class="col"><a id="content2" class="nav-link item-bottom " style="font-family:'SUITE-Regular';" href="myResvList.do">나의 예약</a></div>
		<div id="content3" class="col"><a id="content3" class="nav-link item-bottom " style="font-family:'SUITE-Regular';" href="myOrderList.do">나의 주문</a></div>
		<div id="content4" class="col"><a id="content4" class="nav-link item-bottom " style="font-family:'SUITE-Regular';" href="myQnaList.do">나의 질문</a></div>
	</div>
</div>
